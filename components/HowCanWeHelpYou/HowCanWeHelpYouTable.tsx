...
function HowCanWeHelpYouTable({
  ...
  // Current Viewed Data
  const currentPost = HowCanWeHelpYouData.sort((a, b) => b.id - a.id).slice(
    indexOfFirstPost,
    indexOfLastPost
  );
  ...
  const filteredData =
    searchItem === ""
      ...
      : HowCanWeHelpYouData.filter((item) => {
          const status = item.status ? "disable" : "enable";
  ...
  return (
    <Fragment>
      ...
      <Pagination
        ...
        totalPosts={HowCanWeHelpYouData.length}
