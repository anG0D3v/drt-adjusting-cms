    ...
    <div>
      ...
      <form onSubmit={onSubmit} className="">
        <div className="block sm:flex sm:space-x-10 space-y-8 sm:space-y-0 mb-8">
          <div className="xl:flex xl:space-x-5">
            ...
            <div className="space-y-2">
              <label className="text-md font-medium" htmlFor="position">
                Position
              </label>
              <input
                id="position"
        ...
        <div className="block sm:flex sm:space-x-10 space-y-8 sm:space-y-0 mb-8">
          <div className="xl:flex xl:space-x-5">
            <div className="space-y-2 mb-5 xl:mb-0">
              <label className="text-md font-medium" htmlFor="companyName">
                Company Name
              </label>
              <input
                id="companyName"
        ...
        <div className="mb-10 space-y-2">
          <label className="text-md font-medium" htmlFor="content">
            Description{" "}
